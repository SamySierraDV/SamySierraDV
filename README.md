...
**[Demo en YouTube](https://www.youtube.com/watch?v=Ij4cdlLbVZs)**  
**Java + Spring Boot + Vaadin + MongoDB** 
Sistema integral para la optimización y control de existencias en tiempo real (POS, alertas de stock, métricas y reportes).
- 🛠️ Implementación de patrones **MVC** y **DAO** para una separación limpia de responsabilidades.
- 🔍 Monitoreo de salud del sistema con **Spring Boot Actuator** y agente de consulta inteligente en lenguaje natural.

---

### 💬 Foro Alura — API REST
**[Repo en GitHub](https://github.com/SamySierraDV/AluraLatam-ForoHub-Challenge-Alura.git)**  
...
**[Repo en GitHub](https://github.com/SamySierraDV/AluraLatam-Litealura)**  
...
**[Repo en GitHub](https://github.com/SamySierraDV/AluraLatam-Conversor-de-monedas.git)**  
